...
public class YuangongController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        if(u==null || !u.getYuangongmima().equals(EncryptUtil.md5(password))) {
    ...
    public R register(@RequestBody YuangongEntity yuangong){
		...
		yuangong.setId(uId);
        yuangong.setYuangongmima(EncryptUtil.md5(yuangong.getYuangongmima()));
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        u.setYuangongmima(EncryptUtil.md5("123456"));
    ...
    public R update(@RequestBody YuangongEntity yuangong, HttpServletRequest request){
        ...
        if(StringUtils.isNotBlank(yuangong.getYuangongmima()) && !yuangong.getYuangongmima().equals(yuangongEntity.getYuangongmima())) {
            yuangong.setYuangongmima(EncryptUtil.md5(yuangong.getYuangongmima()));
        }
